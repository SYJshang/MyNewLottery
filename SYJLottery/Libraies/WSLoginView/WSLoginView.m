...
- (void)creatSubViews {
    ...
    //猫头
    UIImageView* imgLogin = [[UIImageView alloc] initWithFrame:CGRectMake(KSceenW / 2 - 211 / 2, 150-99, 211, 108)];
    ...
    //展开的左右爪
    imgLeftHandGone = [[UIImageView alloc] initWithFrame:CGRectMake(KSceenW / 2 - 100, 150-22, 40, 40)];
    imgLeftHandGone.image = [UIImage imageNamed:@"icon_hand"];
    [self addSubview:imgLeftHandGone];
    
    
    imgRightHandGone = [[UIImageView alloc] initWithFrame:CGRectMake(KSceenW / 2 + 62,  150-22, 40, 40)];
    ...
    smallView.frame = CGRectMake(20, 150, KSceenW-40, KSceenW-40);
    ...
    smallView.frame = CGRectMake(20, 150, KSceenW-40, CGRectGetMaxY(self.loginBtn.frame)+15);
