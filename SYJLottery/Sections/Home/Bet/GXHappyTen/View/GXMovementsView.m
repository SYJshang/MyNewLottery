...
@implementation GXMovementsView
...
-(void)Switchingperformancedatawithtype:(NSString *)type{
    ...
    [[HttpManager manager] requestGetURL:HTTP_gxK10_trend withParams:dict withTarget:self withHud:YES withSuccessBlock:^(id responseObject) {
        DLog(@"-----= %@", responseObject)
