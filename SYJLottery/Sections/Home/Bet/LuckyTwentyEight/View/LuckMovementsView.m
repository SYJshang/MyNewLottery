...
@implementation LuckMovementsView
...
-(void)Switchingperformancedatawithtype:(NSString *)type{
    ...
    [[HttpManager manager] requestGetURL:HTTP_xjpLu28_trend withParams:dict withTarget:self withHud:YES withSuccessBlock:^(id responseObject) {
        DLog(@"-----= %@", responseObject)
