...
@implementation XJMovementsView
...
-(void)Switchingperformancedatawithtype:(NSString *)type{
    ...
    [[HttpManager manager] requestGetURL:HTTP_xjSsc_trend withParams:dict withTarget:self withHud:YES withSuccessBlock:^(id responseObject) {
        DLog(@"-----= %@", responseObject)
