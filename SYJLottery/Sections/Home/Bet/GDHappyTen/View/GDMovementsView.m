...
@implementation GDMovementsView
...
-(void)Switchingperformancedatawithtype:(NSString *)type{
    ...
    [[HttpManager manager] requestGetURL:HTTP_gdk10_trend withParams:dict withTarget:self withHud:YES withSuccessBlock:^(id responseObject) {
        DLog(@"-----= %@", responseObject)
