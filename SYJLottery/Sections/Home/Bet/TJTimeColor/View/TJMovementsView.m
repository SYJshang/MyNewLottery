...
@implementation TJMovementsView
...
-(void)Switchingperformancedatawithtype:(NSString *)type{
    ...
    DLog(@"-=-=-%@",type);
    [[HttpManager manager] requestGetURL:HTTP_tjSsc_trend withParams:dict withTarget:self withHud:YES withSuccessBlock:^(id responseObject) {
        DLog(@"-----= %@", responseObject)
