...
@interface JSThreeMovementsView ()
{
...
@implementation JSThreeMovementsView
...
-(void)Switchingperformancedatawithtype:(NSString *)type{
    ...
    [dict setValue:type forKey:@"type"];//[必选]类型 0=号码 1和值
    [[HttpManager manager] requestGetURL:HTTP_jsK3_trend withParams:dict withTarget:self withHud:YES withSuccessBlock:^(id responseObject) {
        DLog(@"-----= %@", responseObject)
