...
@implementation SYJForumDetailCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.title = title;
        self.title.sd_layout.leftSpaceToView(self.pic, 5).topSpaceToView(self.contentView, 10).heightIs(20).widthIs(100);
        ...
        self.titleLab.sd_layout.leftSpaceToView(self.pic, 5).topSpaceToView(self.title, 10).heightIs(15).rightSpaceToView(self.contentView, 5);
        ...
        self.contentLab.sd_layout.leftSpaceToView(self.contentView, 15).topSpaceToView(self.pic, 5).autoHeightRatio(0).rightSpaceToView(self.contentView, 15);
        ...
        self.line2 = line2;
        self.line2.sd_layout.centerXEqualToView(self.contentView).topSpaceToView(self.lineBottom, 0).heightIs(30).widthIs(1);
        
        [self setupAutoHeightWithBottomView:line2 bottomMargin:0];
